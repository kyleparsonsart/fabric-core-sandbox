# Apollo Brand × Product

**Author:** Kyle Parsons
**Status:** Not started
**Work Stream:** Framework

---

## Where the Brand Lives

Apollo's brand is its visual and verbal identity — cohesively expressed across both Marketing and Product. These aren't separate brands. They're different expressions of the same one.

| | Marketing | Marketing × Product | Product |
|---|---|---|---|
| **Mode** | Inspiring, storytelling, value/benefit driven | Marketing elements in product; product in marketing | Practical, helpful, get out of the way |
| **Goal** | Make someone want Apollo | Bridge the promise to the experience | Help someone accomplish a task |
...
Apollo is one brand. Marketing and product are two expressions of it — not separate things, but different modes of the same end-to-end experience. From the first ad a prospect sees to the data table they use every day, it should all feel unmistakably Apollo.

The product *is* the brand. Every surface a user touches is a brand surface. What changes across those surfaces is the mode: when to lead with identity and energy, and when to get out of the way and let people work.

Brand expression used everywhere loses its power. Reserved for the right moments — first encounters, upgrade decisions, meaningful milestones — it reinforces why Apollo is different.

**One brand. Every surface. Know when to show it.**
...
| **Helpful** | The product exists to make users successful. Copy that gets out of the way and moves them forward is the goal. |
...
**Brand**
- Voice & Tone — share with copywriter

**Product**
- First pass at marketing section (for Aaron to update)
- Updates
