...
| Token | Light | Dark |
|---|---|---|
| `alpha/highlight-0` | `#FFFFFF` 0% | `#FFFFFF` 0% |
| `alpha/highlight-1` | `#FFFFFF` 15% | `#FFFFFF` 15% |
| `alpha/highlight-2` | `#FFFFFF` 25% | `#FFFFFF` 25% |
| `alpha/shadow-0` | `#000000` 0% | `#050505` 0% |
| `alpha/shadow-1` | `#2E2B29` 3% | `#050505` 5% |
| `alpha/shadow-2` | `#2E2B29` 5% | `#050505` 6% |
| `alpha/shadow-3` | `#2E2B29` 6% | `#050505` 12% |
| `alpha/shadow-4` | `#2E2B29` 8% | `#050505` 14% |
| `alpha/shadow-5` | `#2E2B29` 9% | `#050505` 15% |
| `alpha/shadow-6` | `#2E2B29` 15% | `#050505` 25% |
| `alpha/shadow-7` | `#2E2B29` 25% | `#050505` 30% |
| `alpha/border` | `#2E2B29` 10% | `#424143` 100% |
| `alpha/overlay` | `#2E2B29` 20% | `#0D0D0D` 50% |
| `alpha/overlay-inverse` | `#FFFFFF` 20% | `#2B2A2C` 20% |

## Elevation

| Token | Light | Dark |
|---|---|---|
| `elevation-1` | `#FFFFFF` | `#2B2A2C` |
| `elevation-2` | `#FFFFFF` | `#2E2D2F` |
| `elevation-3` | `#FFFFFF` | `#302F31` |
| `elevation-4` | `#FFFFFF` | `#2E2D2F` |
| `elevation-5` | `#FFFFFF` | `#2E2D2F` |

## Brand

| Token | Light | Dark |
|---|---|---|
| `brand/hubspot-10` | `#FFE2DB` | `#FF7A59` |
| `brand/hubspot-50` | `#FF7A59` | `#FFE2DB` |
| `brand/linkedin-10` | `#CEE5FC` | `#0077B5` |
| `brand/linkedin-50` | `#0077B5` | `#CEE5FC` |

## Constants

| Token | Light | Dark |
|---|---|---|
| `constants/dark` | `#2B2826` | `#2B2A2C` |
| `constants/light` | `#FFFFFF` | `#FFFFFF` |
...
| Token | Value | Alpha |
|---|---|---|
| `state/hover` | `#000000` | 10% |
| `state/pressed` | `#000000` | 20% |
...
| Token | Light |
|---|---|
| `bg/alpha/shadow/base/default` | `#000000` 0% |
| `bg/alpha/highlight/base` | `#FFFFFF` 0% |
| `bg/alpha/highlight/subtle` | `#FFFFFF` 15% |
| `bg/alpha/highlight/muted` | `#FFFFFF` 25% |
